           ...
           <div class="row">
            ...
            <div class="row">
              ...
              <p><h3>DEPENDANTS</h3></p>
                  ...
                  <div class="col-md-3">
                  <label>Address</label><input type="text" class="form-control" name="dependantaddress1" value="<?php echo $row['D_O_B'] ?>">
                  </div>

                  <div class="col-md-3">
                  <label>Phone No</label><input type="number" class="form-control" name="dependantphone1" value="<?php echo $row['D_O_B'] ?>">
                  </div>
